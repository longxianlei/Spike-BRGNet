...
def get_seg_model(cfg, imgnet_pretrained):
    ...
    if cfg.DATASET.event_representation == 'voxel_grid_1':
        input_channel = 1
    ...
    if 's' in cfg.MODEL.NAME:
        ...
        model = SpikeBRGNet(input_channel, m=2, n=3, num_classes=cfg.DATASET.NUM_CLASSES, planes=64, 
                       ppm_planes=96, head_planes=128, augment=True)
    else:
        model = SpikeBRGNet(input_channel, m=3, n=4, num_classes=cfg.DATASET.NUM_CLASSES, planes=64, 
...
def get_pred_model(cfg, name, num_classes):
    ...
    if 's' in name:
        ...
        model = SpikeBRGNet(input_channel, m=2, n=3, num_classes=num_classes, planes=64, 
                       ppm_planes=96, head_planes=128, augment=False)
    else:
        model = SpikeBRGNet(input_channel, m=3, n=4, num_classes=num_classes, planes=64, 
