...
def parse_args():
    ...
    #                     default="/home/ubuntu/code/SpikeBRGNet/configs/DDD17SpikeBRGNet_small_DDD17.yaml",
    #                     type=str)   
    parser.add_argument('--cfg',
                        help='experiment configure file name', 
                        default="/home/ubuntu/code/SpikeBRGNet/configs/DSEC/SpikeBRGNet_small_DSEC.yaml",
                        type=str)
